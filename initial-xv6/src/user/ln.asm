...
main(int argc, char *argv[])
{
  ...
  14:	83058593          	addi	a1,a1,-2000 # 840 <malloc+0xf0>
  18:	4509                	li	a0,2
  ...
  50:	80c58593          	addi	a1,a1,-2036 # 858 <malloc+0x108>
  54:	4509                	li	a0,2
...
putc(int fd, char c)
{
 ...
 3d4:	f36080e7          	jalr	-202(ra) # 306 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	4ce50513          	addi	a0,a0,1230 # 8d0 <digits>
 40a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c6:	3b6c8c93          	addi	s9,s9,950 # 878 <malloc+0x128>
 ...
 4d4:	400b8b93          	addi	s7,s7,1024 # 8d0 <digits>
 ...
 5fa:	27a98993          	addi	s3,s3,634 # 870 <malloc+0x120>
        while(*s != 0){
 5fe:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 82a:	b48080e7          	jalr	-1208(ra) # 36e <sbrk>
  if(p == (char*)-1)
