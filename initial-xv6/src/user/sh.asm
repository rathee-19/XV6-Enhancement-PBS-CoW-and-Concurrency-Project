...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	32e58593          	addi	a1,a1,814 # 1340 <malloc+0xf2>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2e858593          	addi	a1,a1,744 # 1348 <malloc+0xfa>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	0fe080e7          	jalr	254(ra) # 1168 <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2b650513          	addi	a0,a0,694 # 1350 <malloc+0x102>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	38a70713          	addi	a4,a4,906 # 1450 <malloc+0x202>
    ...
    panic("runcmd");
      ...
      e4:	27850513          	addi	a0,a0,632 # 1358 <malloc+0x10a>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	25e58593          	addi	a1,a1,606 # 1360 <malloc+0x112>
     10a:	4509                	li	a0,2
     10c:	00001097          	auipc	ra,0x1
     110:	05c080e7          	jalr	92(ra) # 1168 <fprintf>
  exit(0);
     114:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     152:	22258593          	addi	a1,a1,546 # 1370 <malloc+0x122>
     156:	4509                	li	a0,2
     158:	00001097          	auipc	ra,0x1
     15c:	010080e7          	jalr	16(ra) # 1168 <fprintf>
      exit(1);
     160:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1e8:	19c50513          	addi	a0,a0,412 # 1380 <malloc+0x132>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28a:	fc8080e7          	jalr	-56(ra) # 124e <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d4:	f7e080e7          	jalr	-130(ra) # 124e <malloc>
     2d8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32e:	f24080e7          	jalr	-220(ra) # 124e <malloc>
     332:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     374:	ede080e7          	jalr	-290(ra) # 124e <malloc>
     378:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37a:	4661                	li	a2,24
     37c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b6:	e9c080e7          	jalr	-356(ra) # 124e <malloc>
     3ba:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	dfcb8b93          	addi	s7,s7,-516 # 13a8 <malloc+0x15a>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	dca50513          	addi	a0,a0,-566 # 1388 <malloc+0x13a>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	d0a60613          	addi	a2,a2,-758 # 13b0 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	cfab0b13          	addi	s6,s6,-774 # 13d0 <malloc+0x182>
  ...
  return ret;
     ...
     714:	ca850513          	addi	a0,a0,-856 # 13b8 <malloc+0x16a>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     776:	c4e50513          	addi	a0,a0,-946 # 13c0 <malloc+0x172>
...
0000000000000790 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b0:	c2c60613          	addi	a2,a2,-980 # 13d8 <malloc+0x18a>
     7b4:	85ce                	mv	a1,s3
     7b6:	854a                	mv	a0,s2
...
00000000000007fe <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     820:	bc4a0a13          	addi	s4,s4,-1084 # 13e0 <malloc+0x192>
  ...
  if(peek(ps, es, ";")){
     ...
     856:	b9660613          	addi	a2,a2,-1130 # 13e8 <malloc+0x19a>
     85a:	85ce                	mv	a1,s3
     85c:	854a                	mv	a0,s2
...
00000000000008a6 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8bc:	af860613          	addi	a2,a2,-1288 # 13b0 <malloc+0x162>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ec:	b1860613          	addi	a2,a2,-1256 # 1400 <malloc+0x1b2>
     8f0:	85ca                	mv	a1,s2
     8f2:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92e:	ac650513          	addi	a0,a0,-1338 # 13f0 <malloc+0x1a2>
     932:	fffff097          	auipc	ra,0xfffff
     936:	724080e7          	jalr	1828(ra) # 56 <panic>
    panic("syntax - missing )");
     93a:	00001517          	auipc	a0,0x1
     93e:	ace50513          	addi	a0,a0,-1330 # 1408 <malloc+0x1ba>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96a:	b0270713          	addi	a4,a4,-1278 # 1468 <malloc+0x21a>
...
00000000000009e2 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a16:	a0e60613          	addi	a2,a2,-1522 # 1420 <malloc+0x1d2>
     a1a:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4c:	9e058593          	addi	a1,a1,-1568 # 1428 <malloc+0x1da>
     a50:	4509                	li	a0,2
     a52:	00000097          	auipc	ra,0x0
     a56:	716080e7          	jalr	1814(ra) # 1168 <fprintf>
    panic("syntax");
     a5a:	00001517          	auipc	a0,0x1
     a5e:	95e50513          	addi	a0,a0,-1698 # 13b8 <malloc+0x16a>
...
0000000000000a6a <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	9bc48493          	addi	s1,s1,-1604 # 1438 <malloc+0x1ea>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     abe:	986a8a93          	addi	s5,s5,-1658 # 1440 <malloc+0x1f2>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	636080e7          	jalr	1590(ra) # 1168 <fprintf>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ed2:	f36080e7          	jalr	-202(ra) # e04 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f04:	5e050513          	addi	a0,a0,1504 # 14e0 <digits>
     f08:	883a                	mv	a6,a4
...
{
     f8a:	7119                	addi	sp,sp,-128
     f8c:	fc86                	sd	ra,120(sp)
     f8e:	f8a2                	sd	s0,112(sp)
     f90:	f4a6                	sd	s1,104(sp)
     f92:	f0ca                	sd	s2,96(sp)
     f94:	ecce                	sd	s3,88(sp)
     f96:	e8d2                	sd	s4,80(sp)
     f98:	e4d6                	sd	s5,72(sp)
     f9a:	e0da                	sd	s6,64(sp)
     f9c:	fc5e                	sd	s7,56(sp)
     f9e:	f862                	sd	s8,48(sp)
     fa0:	f466                	sd	s9,40(sp)
     fa2:	f06a                	sd	s10,32(sp)
     fa4:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fac:	18090f63          	beqz	s2,114a <vprintf+0x1c0>
     fb0:	8aaa                	mv	s5,a0
     fb2:	8b32                	mv	s6,a2
  ...
  state = 0;
     ...
     fbe:	4c55                	li	s8,21
     fc0:	00000c97          	auipc	s9,0x0
     fc4:	4c8c8c93          	addi	s9,s9,1224 # 1488 <malloc+0x23a>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
     fc8:	02800d93          	li	s11,40
  putc(fd, 'x');
     fcc:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fce:	00000b97          	auipc	s7,0x0
     fd2:	512b8b93          	addi	s7,s7,1298 # 14e0 <digits>
     fd6:	a839                	j	ff4 <vprintf+0x6a>
        putc(fd, c);
     fd8:	85ca                	mv	a1,s2
     fda:	8556                	mv	a0,s5
     fdc:	00000097          	auipc	ra,0x0
     fe0:	ee0080e7          	jalr	-288(ra) # ebc <putc>
     fe4:	a019                	j	fea <vprintf+0x60>
    } else if(state == '%'){
     fe6:	01498d63          	beq	s3,s4,1000 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
     fea:	0485                	addi	s1,s1,1
     fec:	fff4c903          	lbu	s2,-1(s1)
     ff0:	14090d63          	beqz	s2,114a <vprintf+0x1c0>
    if(state == 0){
     ff4:	fe0999e3          	bnez	s3,fe6 <vprintf+0x5c>
      if(c == '%'){
     ff8:	ff4910e3          	bne	s2,s4,fd8 <vprintf+0x4e>
        state = '%';
     ffc:	89d2                	mv	s3,s4
     ffe:	b7f5                	j	fea <vprintf+0x60>
      if(c == 'd'){
    1000:	11490c63          	beq	s2,s4,1118 <vprintf+0x18e>
    1004:	f9d9079b          	addiw	a5,s2,-99
    1008:	0ff7f793          	zext.b	a5,a5
    100c:	10fc6e63          	bltu	s8,a5,1128 <vprintf+0x19e>
    1010:	f9d9079b          	addiw	a5,s2,-99
    1014:	0ff7f713          	zext.b	a4,a5
    1018:	10ec6863          	bltu	s8,a4,1128 <vprintf+0x19e>
    101c:	00271793          	slli	a5,a4,0x2
    1020:	97e6                	add	a5,a5,s9
    1022:	439c                	lw	a5,0(a5)
    ...
    103a:	ea8080e7          	jalr	-344(ra) # ede <printint>
    103e:	8b4a                	mv	s6,s2
      } else {
    ...
    1056:	e8c080e7          	jalr	-372(ra) # ede <printint>
    105a:	8b4a                	mv	s6,s2
      state = 0;
    105c:	4981                	li	s3,0
    105e:	b771                	j	fea <vprintf+0x60>
    ...
    1072:	e70080e7          	jalr	-400(ra) # ede <printint>
    1076:	8b4a                	mv	s6,s2
      state = 0;
    1078:	4981                	li	s3,0
    107a:	bf85                	j	fea <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    1092:	e2e080e7          	jalr	-466(ra) # ebc <putc>
  putc(fd, 'x');
    1096:	07800593          	li	a1,120
    109a:	8556                	mv	a0,s5
    109c:	00000097          	auipc	ra,0x0
    10a0:	e20080e7          	jalr	-480(ra) # ebc <putc>
    10a4:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    10a6:	03c9d793          	srli	a5,s3,0x3c
    10aa:	97de                	add	a5,a5,s7
    10ac:	0007c583          	lbu	a1,0(a5)
    10b0:	8556                	mv	a0,s5
    10b2:	00000097          	auipc	ra,0x0
    10b6:	e0a080e7          	jalr	-502(ra) # ebc <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10ba:	0992                	slli	s3,s3,0x4
    10bc:	397d                	addiw	s2,s2,-1
    10be:	fe0914e3          	bnez	s2,10a6 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    10c2:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10c6:	4981                	li	s3,0
    10c8:	b70d                	j	fea <vprintf+0x60>
        s = va_arg(ap, char*);
    10ca:	008b0913          	addi	s2,s6,8
    10ce:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    10d2:	02098163          	beqz	s3,10f4 <vprintf+0x16a>
        while(*s != 0){
    10d6:	0009c583          	lbu	a1,0(s3)
    10da:	c5ad                	beqz	a1,1144 <vprintf+0x1ba>
          putc(fd, *s);
    10dc:	8556                	mv	a0,s5
    10de:	00000097          	auipc	ra,0x0
    10e2:	dde080e7          	jalr	-546(ra) # ebc <putc>
          s++;
    10e6:	0985                	addi	s3,s3,1
        while(*s != 0){
    10e8:	0009c583          	lbu	a1,0(s3)
    10ec:	f9e5                	bnez	a1,10dc <vprintf+0x152>
        s = va_arg(ap, char*);
    10ee:	8b4a                	mv	s6,s2
      state = 0;
    10f0:	4981                	li	s3,0
    10f2:	bde5                	j	fea <vprintf+0x60>
          s = "(null)";
    10f4:	00000997          	auipc	s3,0x0
    10f8:	38c98993          	addi	s3,s3,908 # 1480 <malloc+0x232>
        while(*s != 0){
    10fc:	85ee                	mv	a1,s11
    10fe:	bff9                	j	10dc <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    1100:	008b0913          	addi	s2,s6,8
    1104:	000b4583          	lbu	a1,0(s6)
    1108:	8556                	mv	a0,s5
    110a:	00000097          	auipc	ra,0x0
    110e:	db2080e7          	jalr	-590(ra) # ebc <putc>
    1112:	8b4a                	mv	s6,s2
      state = 0;
    1114:	4981                	li	s3,0
    1116:	bdd1                	j	fea <vprintf+0x60>
        putc(fd, c);
    1118:	85d2                	mv	a1,s4
    111a:	8556                	mv	a0,s5
    111c:	00000097          	auipc	ra,0x0
    1120:	da0080e7          	jalr	-608(ra) # ebc <putc>
      state = 0;
    1124:	4981                	li	s3,0
    1126:	b5d1                	j	fea <vprintf+0x60>
        putc(fd, '%');
    1128:	85d2                	mv	a1,s4
    112a:	8556                	mv	a0,s5
    ...
    113c:	d84080e7          	jalr	-636(ra) # ebc <putc>
      state = 0;
    1140:	4981                	li	s3,0
    1142:	b565                	j	fea <vprintf+0x60>
        s = va_arg(ap, char*);
    1144:	8b4a                	mv	s6,s2
      state = 0;
    1146:	4981                	li	s3,0
    1148:	b54d                	j	fea <vprintf+0x60>
    }
  }
}
    114a:	70e6                	ld	ra,120(sp)
    114c:	7446                	ld	s0,112(sp)
    114e:	74a6                	ld	s1,104(sp)
    1150:	7906                	ld	s2,96(sp)
    1152:	69e6                	ld	s3,88(sp)
    1154:	6a46                	ld	s4,80(sp)
    1156:	6aa6                	ld	s5,72(sp)
    1158:	6b06                	ld	s6,64(sp)
    115a:	7be2                	ld	s7,56(sp)
    115c:	7c42                	ld	s8,48(sp)
    115e:	7ca2                	ld	s9,40(sp)
    1160:	7d02                	ld	s10,32(sp)
    1162:	6de2                	ld	s11,24(sp)
    1164:	6109                	addi	sp,sp,128
    1166:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    118a:	e04080e7          	jalr	-508(ra) # f8a <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    11c0:	dce080e7          	jalr	-562(ra) # f8a <vprintf>
}
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    12aa:	de278793          	addi	a5,a5,-542 # 2088 <base>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1328:	b48080e7          	jalr	-1208(ra) # e6c <sbrk>
  if(p == (char*)-1)
