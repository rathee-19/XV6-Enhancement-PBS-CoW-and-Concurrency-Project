...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2e650513          	addi	a0,a0,742 # 1380 <malloc+0xe8>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2d650513          	addi	a0,a0,726 # 1380 <malloc+0xe8>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	2cc50513          	addi	a0,a0,716 # 1388 <malloc+0xf0>
  ...
  chdir("/");
      ...
      da:	2d250513          	addi	a0,a0,722 # 13a8 <malloc+0x110>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	2d298993          	addi	s3,s3,722 # 13b8 <malloc+0x120>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2c098993          	addi	s3,s3,704 # 13b0 <malloc+0x118>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	56c90913          	addi	s2,s2,1388 # 1668 <malloc+0x3d0>
    ...
    if(what == 1){
     ...
     10e:	2b650513          	addi	a0,a0,694 # 13c0 <malloc+0x128>
    ...
    if(what == 1){
     ...
     168:	26c50513          	addi	a0,a0,620 # 13d0 <malloc+0x138>
     ...
     182:	24250513          	addi	a0,a0,578 # 13c0 <malloc+0x128>
     ...
     194:	1f050513          	addi	a0,a0,496 # 1380 <malloc+0xe8>
     ...
     1a6:	24650513          	addi	a0,a0,582 # 13e8 <malloc+0x150>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1f650513          	addi	a0,a0,502 # 13a8 <malloc+0x110>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	1c450513          	addi	a0,a0,452 # 1388 <malloc+0xf0>
     1cc:	00001097          	auipc	ra,0x1
     1d0:	014080e7          	jalr	20(ra) # 11e0 <printf>
        exit(1);
     1d4:	4505                	li	a0,1
     ...
     1f0:	20450513          	addi	a0,a0,516 # 13f0 <malloc+0x158>
     ...
     212:	1f250513          	addi	a0,a0,498 # 1400 <malloc+0x168>
     ...
     256:	16e50513          	addi	a0,a0,366 # 13c0 <malloc+0x128>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	1b250513          	addi	a0,a0,434 # 1418 <malloc+0x180>
     ...
     282:	1aa50513          	addi	a0,a0,426 # 1428 <malloc+0x190>
     ...
     294:	1a050513          	addi	a0,a0,416 # 1430 <malloc+0x198>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	19450513          	addi	a0,a0,404 # 1438 <malloc+0x1a0>
     ...
     2c0:	18c50513          	addi	a0,a0,396 # 1448 <malloc+0x1b0>
     ...
     2d2:	14250513          	addi	a0,a0,322 # 1410 <malloc+0x178>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	10a58593          	addi	a1,a1,266 # 13e8 <malloc+0x150>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	16a50513          	addi	a0,a0,362 # 1450 <malloc+0x1b8>
     ...
     2fc:	17050513          	addi	a0,a0,368 # 1468 <malloc+0x1d0>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	0e858593          	addi	a1,a1,232 # 13f0 <malloc+0x158>
     310:	00001517          	auipc	a0,0x1
     314:	16850513          	addi	a0,a0,360 # 1478 <malloc+0x1e0>
     ...
     348:	13c50513          	addi	a0,a0,316 # 1480 <malloc+0x1e8>
     34c:	00001097          	auipc	ra,0x1
     350:	e94080e7          	jalr	-364(ra) # 11e0 <printf>
        exit(1);
     354:	4505                	li	a0,1
     ...
     396:	0ee50513          	addi	a0,a0,238 # 1480 <malloc+0x1e8>
     39a:	00001097          	auipc	ra,0x1
     39e:	e46080e7          	jalr	-442(ra) # 11e0 <printf>
        exit(1);
     3a2:	4505                	li	a0,1
     ...
     3f6:	0a650513          	addi	a0,a0,166 # 1498 <malloc+0x200>
     ...
     422:	04250513          	addi	a0,a0,66 # 1460 <malloc+0x1c8>
     ...
     444:	04050513          	addi	a0,a0,64 # 1480 <malloc+0x1e8>
     448:	00001097          	auipc	ra,0x1
     44c:	d98080e7          	jalr	-616(ra) # 11e0 <printf>
        exit(1);
     450:	4505                	li	a0,1
     ...
     45e:	04e50513          	addi	a0,a0,78 # 14a8 <malloc+0x210>
     462:	00001097          	auipc	ra,0x1
     466:	d7e080e7          	jalr	-642(ra) # 11e0 <printf>
        exit(1);
     46a:	4505                	li	a0,1
     ...
     4ac:	fd850513          	addi	a0,a0,-40 # 1480 <malloc+0x1e8>
     4b0:	00001097          	auipc	ra,0x1
     4b4:	d30080e7          	jalr	-720(ra) # 11e0 <printf>
        exit(1);
     4b8:	4505                	li	a0,1
     ...
     508:	fbc50513          	addi	a0,a0,-68 # 14c0 <malloc+0x228>
     50c:	00001097          	auipc	ra,0x1
     510:	cd4080e7          	jalr	-812(ra) # 11e0 <printf>
        exit(1);
     514:	4505                	li	a0,1
     ...
     534:	fa858593          	addi	a1,a1,-88 # 14d8 <malloc+0x240>
     ...
     570:	f7450513          	addi	a0,a0,-140 # 14e0 <malloc+0x248>
     574:	00001097          	auipc	ra,0x1
     578:	c6c080e7          	jalr	-916(ra) # 11e0 <printf>
     57c:	b7f9                	j	54a <go+0x4d2>
          printf("grind: pipe read failed\n");
     57e:	00001517          	auipc	a0,0x1
     582:	f8250513          	addi	a0,a0,-126 # 1500 <malloc+0x268>
     586:	00001097          	auipc	ra,0x1
     58a:	c5a080e7          	jalr	-934(ra) # 11e0 <printf>
     58e:	bfd1                	j	562 <go+0x4ea>
        printf("grind: fork failed\n");
     590:	00001517          	auipc	a0,0x1
     594:	ef050513          	addi	a0,a0,-272 # 1480 <malloc+0x1e8>
     598:	00001097          	auipc	ra,0x1
     59c:	c48080e7          	jalr	-952(ra) # 11e0 <printf>
        exit(1);
     5a0:	4505                	li	a0,1
     ...
     636:	e4e50513          	addi	a0,a0,-434 # 1480 <malloc+0x1e8>
     63a:	00001097          	auipc	ra,0x1
     63e:	ba6080e7          	jalr	-1114(ra) # 11e0 <printf>
        exit(1);
     642:	4505                	li	a0,1
     ...
     650:	ed450513          	addi	a0,a0,-300 # 1520 <malloc+0x288>
     ...
     664:	ec050513          	addi	a0,a0,-320 # 1520 <malloc+0x288>
     ...
     67c:	e6058593          	addi	a1,a1,-416 # 14d8 <malloc+0x240>
     ...
     6c2:	e6250513          	addi	a0,a0,-414 # 1520 <malloc+0x288>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e5850513          	addi	a0,a0,-424 # 1528 <malloc+0x290>
     6d8:	00001097          	auipc	ra,0x1
     6dc:	b08080e7          	jalr	-1272(ra) # 11e0 <printf>
        exit(1);
     6e0:	4505                	li	a0,1
     ...
     6ee:	e5650513          	addi	a0,a0,-426 # 1540 <malloc+0x2a8>
     6f2:	00001097          	auipc	ra,0x1
     6f6:	aee080e7          	jalr	-1298(ra) # 11e0 <printf>
        exit(1);
     6fa:	4505                	li	a0,1
     ...
     708:	e5450513          	addi	a0,a0,-428 # 1558 <malloc+0x2c0>
     70c:	00001097          	auipc	ra,0x1
     710:	ad4080e7          	jalr	-1324(ra) # 11e0 <printf>
        exit(1);
     714:	4505                	li	a0,1
     ...
     724:	e5050513          	addi	a0,a0,-432 # 1570 <malloc+0x2d8>
     728:	00001097          	auipc	ra,0x1
     72c:	ab8080e7          	jalr	-1352(ra) # 11e0 <printf>
        exit(1);
     730:	4505                	li	a0,1
     ...
     73e:	e5e50513          	addi	a0,a0,-418 # 1598 <malloc+0x300>
     742:	00001097          	auipc	ra,0x1
     746:	a9e080e7          	jalr	-1378(ra) # 11e0 <printf>
        exit(1);
     74a:	4505                	li	a0,1
     ...
     826:	e1658593          	addi	a1,a1,-490 # 1638 <malloc+0x3a0>
     ...
     84a:	dfa50513          	addi	a0,a0,-518 # 1640 <malloc+0x3a8>
     84e:	00001097          	auipc	ra,0x1
     852:	992080e7          	jalr	-1646(ra) # 11e0 <printf>
        exit(1);
     856:	4505                	li	a0,1
     ...
     864:	c6058593          	addi	a1,a1,-928 # 14c0 <malloc+0x228>
     868:	4509                	li	a0,2
     86a:	00001097          	auipc	ra,0x1
     86e:	948080e7          	jalr	-1720(ra) # 11b2 <fprintf>
        exit(1);
     872:	4505                	li	a0,1
     ...
     880:	c4458593          	addi	a1,a1,-956 # 14c0 <malloc+0x228>
     884:	4509                	li	a0,2
     886:	00001097          	auipc	ra,0x1
     88a:	92c080e7          	jalr	-1748(ra) # 11b2 <fprintf>
        exit(1);
     88e:	4505                	li	a0,1
     ...
     8dc:	ce858593          	addi	a1,a1,-792 # 15c0 <malloc+0x328>
     8e0:	4509                	li	a0,2
     8e2:	00001097          	auipc	ra,0x1
     8e6:	8d0080e7          	jalr	-1840(ra) # 11b2 <fprintf>
          exit(1);
     8ea:	4505                	li	a0,1
     ...
     950:	b3458593          	addi	a1,a1,-1228 # 1480 <malloc+0x1e8>
     954:	4509                	li	a0,2
     956:	00001097          	auipc	ra,0x1
     95a:	85c080e7          	jalr	-1956(ra) # 11b2 <fprintf>
        exit(3);
     95e:	450d                	li	a0,3
     ...
     99c:	c2858593          	addi	a1,a1,-984 # 15c0 <malloc+0x328>
     9a0:	4509                	li	a0,2
     9a2:	00001097          	auipc	ra,0x1
     9a6:	810080e7          	jalr	-2032(ra) # 11b2 <fprintf>
          exit(4);
     9aa:	4511                	li	a0,4
     ...
     9e0:	be458593          	addi	a1,a1,-1052 # 15c0 <malloc+0x328>
     9e4:	4509                	li	a0,2
     9e6:	00000097          	auipc	ra,0x0
     9ea:	7cc080e7          	jalr	1996(ra) # 11b2 <fprintf>
          exit(5);
     9ee:	4515                	li	a0,5
     ...
     a08:	c0c78793          	addi	a5,a5,-1012 # 1610 <malloc+0x378>
     a0c:	faf43423          	sd	a5,-88(s0)
     a10:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a14:	fa840593          	addi	a1,s0,-88
     a18:	00001517          	auipc	a0,0x1
     a1c:	c0050513          	addi	a0,a0,-1024 # 1618 <malloc+0x380>
     a20:	00000097          	auipc	ra,0x0
     a24:	446080e7          	jalr	1094(ra) # e66 <exec>
        fprintf(2, "grind: cat: not found\n");
     a28:	00001597          	auipc	a1,0x1
     a2c:	bf858593          	addi	a1,a1,-1032 # 1620 <malloc+0x388>
     a30:	4509                	li	a0,2
     a32:	00000097          	auipc	ra,0x0
     a36:	780080e7          	jalr	1920(ra) # 11b2 <fprintf>
        exit(6);
     a3a:	4519                	li	a0,6
     ...
     a48:	a3c58593          	addi	a1,a1,-1476 # 1480 <malloc+0x1e8>
     a4c:	4509                	li	a0,2
     a4e:	00000097          	auipc	ra,0x0
     a52:	764080e7          	jalr	1892(ra) # 11b2 <fprintf>
        exit(7);
     a56:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9f450513          	addi	a0,a0,-1548 # 1460 <malloc+0x1c8>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	99450513          	addi	a0,a0,-1644 # 1410 <malloc+0x178>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	9ca50513          	addi	a0,a0,-1590 # 1480 <malloc+0x1e8>
     abe:	00000097          	auipc	ra,0x0
     ac2:	722080e7          	jalr	1826(ra) # 11e0 <printf>
    exit(1);
     ac6:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b02:	98250513          	addi	a0,a0,-1662 # 1480 <malloc+0x1e8>
     b06:	00000097          	auipc	ra,0x0
     b0a:	6da080e7          	jalr	1754(ra) # 11e0 <printf>
    exit(1);
     b0e:	4505                	li	a0,1
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f1c:	f36080e7          	jalr	-202(ra) # e4e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     f3a:	0805c963          	bltz	a1,fcc <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f4e:	7de50513          	addi	a0,a0,2014 # 1728 <digits>
     f52:	883a                	mv	a6,a4
  ...
  if(neg)
     f76:	00088c63          	beqz	a7,f8e <printint+0x66>
    buf[i++] = '-';
     f7a:	fd070793          	addi	a5,a4,-48
     f7e:	00878733          	add	a4,a5,s0
     f82:	02d00793          	li	a5,45
     f86:	fef70823          	sb	a5,-16(a4)
     f8a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     f8e:	02e05863          	blez	a4,fbe <printint+0x96>
...
{
     fd4:	7119                	addi	sp,sp,-128
     fd6:	fc86                	sd	ra,120(sp)
     fd8:	f8a2                	sd	s0,112(sp)
     fda:	f4a6                	sd	s1,104(sp)
     fdc:	f0ca                	sd	s2,96(sp)
     fde:	ecce                	sd	s3,88(sp)
     fe0:	e8d2                	sd	s4,80(sp)
     fe2:	e4d6                	sd	s5,72(sp)
     fe4:	e0da                	sd	s6,64(sp)
     fe6:	fc5e                	sd	s7,56(sp)
     fe8:	f862                	sd	s8,48(sp)
     fea:	f466                	sd	s9,40(sp)
     fec:	f06a                	sd	s10,32(sp)
     fee:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     ff6:	18090f63          	beqz	s2,1194 <vprintf+0x1c0>
     ffa:	8aaa                	mv	s5,a0
     ffc:	8b32                	mv	s6,a2
     ffe:	00158493          	addi	s1,a1,1
  state = 0;
    1002:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    1004:	02500a13          	li	s4,37
    1008:	4c55                	li	s8,21
    100a:	00000c97          	auipc	s9,0x0
    100e:	6c6c8c93          	addi	s9,s9,1734 # 16d0 <malloc+0x438>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    1012:	02800d93          	li	s11,40
  putc(fd, 'x');
    1016:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    1018:	00000b97          	auipc	s7,0x0
    101c:	710b8b93          	addi	s7,s7,1808 # 1728 <digits>
    1020:	a839                	j	103e <vprintf+0x6a>
        putc(fd, c);
    1022:	85ca                	mv	a1,s2
    1024:	8556                	mv	a0,s5
    1026:	00000097          	auipc	ra,0x0
    102a:	ee0080e7          	jalr	-288(ra) # f06 <putc>
    102e:	a019                	j	1034 <vprintf+0x60>
    } else if(state == '%'){
    1030:	01498d63          	beq	s3,s4,104a <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    1034:	0485                	addi	s1,s1,1
    1036:	fff4c903          	lbu	s2,-1(s1)
    103a:	14090d63          	beqz	s2,1194 <vprintf+0x1c0>
    if(state == 0){
    103e:	fe0999e3          	bnez	s3,1030 <vprintf+0x5c>
      if(c == '%'){
    1042:	ff4910e3          	bne	s2,s4,1022 <vprintf+0x4e>
        state = '%';
    1046:	89d2                	mv	s3,s4
    1048:	b7f5                	j	1034 <vprintf+0x60>
      if(c == 'd'){
    104a:	11490c63          	beq	s2,s4,1162 <vprintf+0x18e>
    104e:	f9d9079b          	addiw	a5,s2,-99
    1052:	0ff7f793          	zext.b	a5,a5
    1056:	10fc6e63          	bltu	s8,a5,1172 <vprintf+0x19e>
    105a:	f9d9079b          	addiw	a5,s2,-99
    105e:	0ff7f713          	zext.b	a4,a5
    1062:	10ec6863          	bltu	s8,a4,1172 <vprintf+0x19e>
    1066:	00271793          	slli	a5,a4,0x2
    106a:	97e6                	add	a5,a5,s9
    106c:	439c                	lw	a5,0(a5)
    106e:	97e6                	add	a5,a5,s9
    1070:	8782                	jr	a5
    ...
    1084:	ea8080e7          	jalr	-344(ra) # f28 <printint>
    1088:	8b4a                	mv	s6,s2
      } else {
    ...
    10a0:	e8c080e7          	jalr	-372(ra) # f28 <printint>
    10a4:	8b4a                	mv	s6,s2
      state = 0;
    10a6:	4981                	li	s3,0
    10a8:	b771                	j	1034 <vprintf+0x60>
    ...
    10bc:	e70080e7          	jalr	-400(ra) # f28 <printint>
    10c0:	8b4a                	mv	s6,s2
      state = 0;
    10c2:	4981                	li	s3,0
    10c4:	bf85                	j	1034 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    10c6:	008b0793          	addi	a5,s6,8
    10ca:	f8f43423          	sd	a5,-120(s0)
    10ce:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    10d2:	03000593          	li	a1,48
    10d6:	8556                	mv	a0,s5
    10d8:	00000097          	auipc	ra,0x0
    10dc:	e2e080e7          	jalr	-466(ra) # f06 <putc>
  putc(fd, 'x');
    10e0:	07800593          	li	a1,120
    10e4:	8556                	mv	a0,s5
    10e6:	00000097          	auipc	ra,0x0
    10ea:	e20080e7          	jalr	-480(ra) # f06 <putc>
    10ee:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    1100:	e0a080e7          	jalr	-502(ra) # f06 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1104:	0992                	slli	s3,s3,0x4
    1106:	397d                	addiw	s2,s2,-1
    1108:	fe0914e3          	bnez	s2,10f0 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    110c:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    1110:	4981                	li	s3,0
    1112:	b70d                	j	1034 <vprintf+0x60>
        s = va_arg(ap, char*);
    1114:	008b0913          	addi	s2,s6,8
    1118:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    111c:	02098163          	beqz	s3,113e <vprintf+0x16a>
        while(*s != 0){
    1120:	0009c583          	lbu	a1,0(s3)
    1124:	c5ad                	beqz	a1,118e <vprintf+0x1ba>
          putc(fd, *s);
    1126:	8556                	mv	a0,s5
    1128:	00000097          	auipc	ra,0x0
    112c:	dde080e7          	jalr	-546(ra) # f06 <putc>
          s++;
    1130:	0985                	addi	s3,s3,1
        while(*s != 0){
    1132:	0009c583          	lbu	a1,0(s3)
    1136:	f9e5                	bnez	a1,1126 <vprintf+0x152>
        s = va_arg(ap, char*);
    1138:	8b4a                	mv	s6,s2
      state = 0;
    113a:	4981                	li	s3,0
    113c:	bde5                	j	1034 <vprintf+0x60>
          s = "(null)";
    113e:	00000997          	auipc	s3,0x0
    1142:	58a98993          	addi	s3,s3,1418 # 16c8 <malloc+0x430>
        while(*s != 0){
    1146:	85ee                	mv	a1,s11
    1148:	bff9                	j	1126 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    114a:	008b0913          	addi	s2,s6,8
    114e:	000b4583          	lbu	a1,0(s6)
    1152:	8556                	mv	a0,s5
    1154:	00000097          	auipc	ra,0x0
    1158:	db2080e7          	jalr	-590(ra) # f06 <putc>
    115c:	8b4a                	mv	s6,s2
      state = 0;
    115e:	4981                	li	s3,0
    1160:	bdd1                	j	1034 <vprintf+0x60>
        putc(fd, c);
    1162:	85d2                	mv	a1,s4
    1164:	8556                	mv	a0,s5
    1166:	00000097          	auipc	ra,0x0
    116a:	da0080e7          	jalr	-608(ra) # f06 <putc>
      state = 0;
    116e:	4981                	li	s3,0
    1170:	b5d1                	j	1034 <vprintf+0x60>
        putc(fd, '%');
    1172:	85d2                	mv	a1,s4
    1174:	8556                	mv	a0,s5
    1176:	00000097          	auipc	ra,0x0
    117a:	d90080e7          	jalr	-624(ra) # f06 <putc>
        putc(fd, c);
    117e:	85ca                	mv	a1,s2
    1180:	8556                	mv	a0,s5
    1182:	00000097          	auipc	ra,0x0
    1186:	d84080e7          	jalr	-636(ra) # f06 <putc>
      state = 0;
    118a:	4981                	li	s3,0
    118c:	b565                	j	1034 <vprintf+0x60>
        s = va_arg(ap, char*);
    118e:	8b4a                	mv	s6,s2
      state = 0;
    1190:	4981                	li	s3,0
    1192:	b54d                	j	1034 <vprintf+0x60>
    }
  }
}
    1194:	70e6                	ld	ra,120(sp)
    1196:	7446                	ld	s0,112(sp)
    1198:	74a6                	ld	s1,104(sp)
    119a:	7906                	ld	s2,96(sp)
    119c:	69e6                	ld	s3,88(sp)
    119e:	6a46                	ld	s4,80(sp)
    11a0:	6aa6                	ld	s5,72(sp)
    11a2:	6b06                	ld	s6,64(sp)
    11a4:	7be2                	ld	s7,56(sp)
    11a6:	7c42                	ld	s8,48(sp)
    11a8:	7ca2                	ld	s9,40(sp)
    11aa:	7d02                	ld	s10,32(sp)
    11ac:	6de2                	ld	s11,24(sp)
    11ae:	6109                	addi	sp,sp,128
    11b0:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    11d4:	e04080e7          	jalr	-508(ra) # fd4 <vprintf>
}
    11d8:	60e2                	ld	ra,24(sp)
    11da:	6442                	ld	s0,16(sp)
    11dc:	6161                	addi	sp,sp,80
    11de:	8082                	ret
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    12ac:	02051493          	slli	s1,a0,0x20
    12b0:	9081                	srli	s1,s1,0x20
    12b2:	04bd                	addi	s1,s1,15
    12b4:	8091                	srli	s1,s1,0x4
    12b6:	0014899b          	addiw	s3,s1,1
    12ba:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    12bc:	00001517          	auipc	a0,0x1
    12c0:	d5453503          	ld	a0,-684(a0) # 2010 <freep>
    12c4:	c515                	beqz	a0,12f0 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    12ca:	02977f63          	bgeu	a4,s1,1308 <malloc+0x70>
    12ce:	8a4e                	mv	s4,s3
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12e8:	d2c90913          	addi	s2,s2,-724 # 2010 <freep>
  if(p == (char*)-1)
    12ec:	5afd                	li	s5,-1
    12ee:	a895                	j	1362 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    ...
    if(p->s.size >= nunits){
    1306:	b7e1                	j	12ce <malloc+0x36>
      if(p->s.size == nunits)
    1308:	02e48c63          	beq	s1,a4,1340 <malloc+0xa8>
        p->s.size -= nunits;
    ...
    1324:	cea73823          	sd	a0,-784(a4) # 2010 <freep>
      return (void*)(p + 1);
    ...
    1342:	e118                	sd	a4,0(a0)
    1344:	bff1                	j	1320 <malloc+0x88>
  hp->s.size = nu;
    1346:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    134a:	0541                	addi	a0,a0,16
    134c:	00000097          	auipc	ra,0x0
    1350:	eca080e7          	jalr	-310(ra) # 1216 <free>
  return freep;
    1354:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1358:	d971                	beqz	a0,132c <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    135a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    135c:	4798                	lw	a4,8(a5)
    135e:	fa9775e3          	bgeu	a4,s1,1308 <malloc+0x70>
    if(p == freep)
    1362:	00093703          	ld	a4,0(s2)
    1366:	853e                	mv	a0,a5
    1368:	fef719e3          	bne	a4,a5,135a <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    136c:	8552                	mv	a0,s4
    136e:	00000097          	auipc	ra,0x0
    1372:	b48080e7          	jalr	-1208(ra) # eb6 <sbrk>
  if(p == (char*)-1)
    1376:	fd5518e3          	bne	a0,s5,1346 <malloc+0xae>
        return 0;
    137a:	4501                	li	a0,0
    137c:	bf45                	j	132c <malloc+0x94>
